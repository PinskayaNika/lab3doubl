...
public class SparkAirports {
    ...
    public static void main(String[] args){
        ...
        final Broadcast<Map<Integer,String>> airportsBroadcasted = AirportFunctions.getAirportBroadcasted(sc,airports);
        JavaPairRDD<Pair<Integer, Integer>, String> scheduleHandled = FlightFunctions.handleSchedule(schedule);
